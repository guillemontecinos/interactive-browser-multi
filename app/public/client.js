...
function buttonSubmit(){
    ...
    clearBtn.mousePressed(clearCurves)
}
...
function isLandscape(){
    if(window.screen.orientation.type == 'landscape-primary' || window.screen.orientation.type == 'landscape-secondary') return true
    else return false
}

//check if the user is mobile
// code source: https://medium.com/simplejs/detect-the-users-device-type-with-a-simple-javascript-check-4fc656b735e1
function isMobile() {
    var check = false;
    (function(a){
